...
import com.xodud1202.springbackend.service.NewsQueryService;
...
public class NewsController {
	...
	public ResponseEntity<List<NewsPressSummaryVO>> getPressList() {
		return ResponseEntity.ok(newsQueryService.getActivePressList());
	}
	...
	public ResponseEntity<List<NewsCategorySummaryVO>> getCategoryList(@RequestParam("pressId") String pressId) {
		return ResponseEntity.ok(newsQueryService.getActiveCategoryList(pressId));
	}
	...
	public ResponseEntity<List<NewsTopArticleVO>> getTopArticleList(
		...
		return ResponseEntity.ok(newsQueryService.getTopArticleList(pressId, categoryId, limit));
	}
}
