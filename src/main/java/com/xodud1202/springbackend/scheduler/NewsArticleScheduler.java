...
import com.xodud1202.springbackend.service.NewsRssCollectService;
...
public class NewsArticleScheduler {
	private final NewsRssCollectService newsRssCollectService;
	...
	public void collectNewsArticleHourly() {
		...
		NewsCollectResultVO collectResult = newsRssCollectService.collectNewsArticles();
		log.info(
